...
//  Route::get('get_weekly_list', \App\Http\Livewire\WeeklyShoppingList::class)->name('shopping_lists.weeklyList');
    Route::post('set_weekly_list', [\App\Http\Controllers\WeeklyShoppingListController::class, 'store'])->name('weekly_list.store');
  Route::get('get_weekly_list', [\App\Http\Controllers\WeeklyShoppingListController::class, 'index'])->name('shopping_lists.weeklyList');
