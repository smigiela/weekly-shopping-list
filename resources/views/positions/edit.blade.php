                        ...
                        <div class="flex col-span-2 sm:col-span-2">
                            ...
                            <div class="ml-2 w-1/4">
                                <label for="type" class="block text-sm font-medium text-gray-700">
                                    {{__('custom.shopping-lists.show.weight')}}
                                </label>
                                <div class="relative inline-block w-full text-gray-700">
                                    ...
                                    @error('type') border-red-500 @enderror"
                                        ...
                                        <option {{ ($position->type == 'quantity' ? 'selected' : '')}} value="quantity">sztuk</option>
                                        <option {{ ($position->type == 'weight' ? 'selected' : '')}} value="weight">gram</option>
                                    </select>
