<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <div class="ml-3 relative inline-flex">
                    @if(auth()->user()->subscribed('premium'))
                        <span
                            class="mr-6 inline-flex items-center justify-center px-2 py-1 mr-2 text-xs font-bold leading-none text-red-100 bg-red-600 rounded-full">PREMIUM</span>
                    @else
                        <span
                            class="mr-6 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-indigo-100 bg-indigo-700 rounded">Free</span>
                    @endif
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <a href="javascript:history.back()" class="text-lg block font-semibold py-2 px-2
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden fadeIn">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('shopping_lists.index') }}"
                                       :active="request()->routeIs('shopping_lists.index')">
                {{ __('custom.nav.shopping_lists') }}
            </x-jet-responsive-nav-link>
        </div>
    ...
    <!-- Responsive Settings Options -->
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="flex items-center px-4">
                ...
                @if(auth()->user()->subscribed('premium'))
                    <span
                        class="ml-6 inline-flex items-center justify-center px-2 py-1 mr-2 text-xs font-bold leading-none text-red-100 bg-red-600 rounded-full">PREMIUM</span>
                @else
                    <span
                        class="ml-6 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-indigo-100 bg-indigo-700 rounded">Free</span>
                @endif
            </div>
